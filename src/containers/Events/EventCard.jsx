...
const EventCard = ({ eventData }) => {
  ...
  <div key={event._id} className="flex flex-col justify-between h-[350px] w-[350px] p-3 md:p-[20px] md:mx-4 mx-auto bg-white rounded-md shadow-lg shadow-gray-400 dark:hover:bg-blueColor hover:bg-primary dark:bg-slate-700 dark:shadow-none sm:w-full md:w-1/2 lg:w-1/2 xl:w-1/2">
  <div className="upperpart flex justify-between">
    <div className="titlecountry flex-grow">
      ...
      <p className="text-[#8b8b8b] group-hover:text-[#dadada] dark:text-slate-400">{event.organisateur}</p>
      <p className="text-[#8b8b8b] group-hover:text-[#dadada] dark:text-slate-400">
        {event.emailContact}, {event.telephoneContact}
      </p>
    </div>
